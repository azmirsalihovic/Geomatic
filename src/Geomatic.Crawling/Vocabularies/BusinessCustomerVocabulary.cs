...
namespace CluedIn.Crawling.Geometic.Vocabularies
{
    public class BusinessCustomerVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "Geometic Business Customer"; // TODO: Set value
            KeyPrefix = "geometic.businesscustomer"; // TODO: Set value
            KeySeparator = ".";
            Grouping = EntityType.Organization; // TODO: Set value

            AddGroup("Geometic Business Customer Details", group =>
            {
            ...
            //Semler vocabs
            AddMapping(OutputStreetline, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(OutputStednavn, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(OutputStrname, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(OutputHounoNum, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(OutputHounoAlpha, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(OutputFloor, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(OutputSuite, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per1Lokalitet, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per1Streetline, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per1Stednavn, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per1AdrContact1, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per1AdrContact2, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per1AdrContact3, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per1AdrContact4, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per1AdrContact5, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per1AdrForeign1, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per1AdrForeign2, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per1AdrForeign3, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per1AdrForeign4, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per1AdrForeign5, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per2Lokalitet, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per2Streetline, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per2Stednavn, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per2AdrContact1, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per2AdrContact2, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per2AdrContact3, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per1AdrContact4, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per2AdrContact5, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per2AdrForeign1, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per2AdrForeign2, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per2AdrForeign3, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per2AdrForeign4, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per2AdrForeign5, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(OutputCareof, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.COName);
            AddMapping(Per1Careof, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.COName);
            AddMapping(Per2Careof, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.COName);
            AddMapping(OutputPdistname, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.City);
            AddMapping(Per1Pdistname, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.City);
            AddMapping(Per2Pdistname, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.City);
            AddMapping(OutputNameFirst, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.FirstName);
            AddMapping(Per1NameFirsts, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.FirstName);
            AddMapping(OutputNameLast, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.LastName);
            AddMapping(OutputNameFirst, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.LastName);
            AddMapping(Per2NameLast, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.FirstName);
            AddMapping(OutputName, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Name);
            AddMapping(Per1InputName, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Name);
            AddMapping(Per1NameAdr, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Name);
            AddMapping(Per2InputName, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Name);
            AddMapping(Per2NameAdr, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Name);
            AddMapping(Mobile, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.PhoneNumber);
            AddMapping(OutputPcode, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.PostalCode);
            AddMapping(Per1Pcode, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.PostalCode);
            AddMapping(Per2Pcode, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.PostalCode);
            AddMapping(OutputLokalitet, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.Address);
            AddMapping(Per2NameFirsts, Semler.Common.Vocabularies.SemlerVocabularies.BusinessCustomer.FirstName);
        }
