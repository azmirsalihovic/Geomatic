...
namespace CluedIn.Crawling.Geometic.Vocabularies
{
    public class PrivateCustomerVocabulary : SimpleVocabulary
    {
        public PrivateCustomerVocabulary()
        {
            ...
            //Semler vocabs
            AddMapping(OutputStreetline, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(OutputStednavn, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(OutputStrname, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(OutputHounoNum, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(OutputHounoAlpha, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(OutputFloor, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(OutputSuite, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per1Lokalitet, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per1Streetline, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per1Stednavn, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per1AdrContact1, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per1AdrContact2, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per1AdrContact3, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per1AdrContact4, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per1AdrContact5, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per1AdrForeign1, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per1AdrForeign2, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per1AdrForeign3, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per1AdrForeign4, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per1AdrForeign5, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per2Lokalitet, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per2Streetline, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per2Stednavn, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per2AdrContact1, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per2AdrContact2, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per2AdrContact3, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per1AdrContact4, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per2AdrContact5, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per2AdrForeign1, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per2AdrForeign2, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per2AdrForeign3, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per2AdrForeign4, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per2AdrForeign5, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(OutputCareof, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.COName);
            AddMapping(Per1Careof, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.COName);
            AddMapping(Per2Careof, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.COName);
            AddMapping(OutputPdistname, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.City);
            AddMapping(Per1Pdistname, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.City);
            AddMapping(Per2Pdistname, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.City);
            AddMapping(OutputNameFirst, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.FirstName);
            AddMapping(Per1NameFirsts, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.FirstName);
            AddMapping(OutputNameLast, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.LastName);
            AddMapping(OutputNameFirst, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.LastName);
            AddMapping(Per2NameLast, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.FirstName);
            AddMapping(OutputName, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Name);
            AddMapping(Per1InputName, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Name);
            AddMapping(Per1NameAdr, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Name);
            AddMapping(Per2InputName, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Name);
            AddMapping(Per2NameAdr, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Name);
            AddMapping(Mobile, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.PhoneNumber);
            AddMapping(OutputPcode, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.PostalCode);
            AddMapping(Per1Pcode, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.PostalCode);
            AddMapping(Per2Pcode, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.PostalCode);
            AddMapping(OutputLokalitet, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.Address);
            AddMapping(Per2NameFirsts, Semler.Common.Vocabularies.SemlerVocabularies.PrivateCustomer.FirstName);
        }
