...
{
    public class Geomatic_Command_MeshProcessor : BaseMeshProcessor
    {
        public Geomatic_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          GeomaticConstants.ProviderId;
