...
namespace CluedIn.Crawling.Geomatic.Infrastructure.Installers
{
    public class InstallComponents : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container
                ...
                .Register(Component.For<IGeomaticClientFactory>().AsFactory())
                .Register(Component.For<GeomaticClient>().LifestyleTransient());
